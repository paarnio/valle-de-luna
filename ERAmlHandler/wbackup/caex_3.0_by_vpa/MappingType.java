 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="InterfaceIDMapping" maxOccurs="unbounded" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;extension base="{}CAEXBasicObject"&gt;
 *                 &lt;attribute name="SystemUnitInterfaceID" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *                 &lt;attribute name="RoleInterfaceID" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *               &lt;/extension&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
    ...
    extends CAEXBasicObject
{
    ...
    protected List<MappingType.InterfaceIDMapping> interfaceIDMapping;
    ...
    /**
     * Gets the value of the interfaceIDMapping property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the interfaceIDMapping property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterfaceIDMapping().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MappingType.InterfaceIDMapping }
     * 
     * 
     */
    public List<MappingType.InterfaceIDMapping> getInterfaceIDMapping() {
        if (interfaceIDMapping == null) {
            interfaceIDMapping = new ArrayList<MappingType.InterfaceIDMapping>();
        }
        return this.interfaceIDMapping;
    }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class InterfaceIDMapping
        extends CAEXBasicObject
    {

        @XmlAttribute(name = "SystemUnitInterfaceID", required = true)
        protected String systemUnitInterfaceID;
        @XmlAttribute(name = "RoleInterfaceID", required = true)
        protected String roleInterfaceID;

        /**
         * Gets the value of the systemUnitInterfaceID property.
         * 
         * @return
         *     possible object is
         *     {@link String }
        ...
        /**
         * Sets the value of the systemUnitInterfaceID property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setSystemUnitInterfaceID(String value) {
            this.systemUnitInterfaceID = value;
        }

        /**
         * Gets the value of the roleInterfaceID property.
         * 
         * @return
         *     possible object is
         *     {@link String }
        ...
        /**
         * Sets the value of the roleInterfaceID property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setRoleInterfaceID(String value) {
            this.roleInterfaceID = value;
        }
